...
export default function PaymentPanel() {
  ...
  const savedCourse = sessionStorage.getItem("selectedCourse") || "Houdini Animation";
      ...
      <div className="w-full max-w-xl bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur">
        ...
        {!enrollmentId && (
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="w-full p-3 rounded bg-black/50 border border-violet-500/50 text-violet-400 font-semibold">
                Course: {form.course}
              </div>
        ...
        {enrollmentId && status === "pending" && (
          <div className="text-center py-10 space-y-5">
            ...
            <p className="text-slate-400">Our team is reviewing your payment.</p>
            <p className="text-slate-400">This page will update automatically once approved.</p>
            <p className="text-xs text-slate-600">Please keep this page open.</p>
          </div>
        )}
        ...
        {status === "confirmed" && whatsappLink && (
          <div className="text-center py-10 space-y-5">
            ...
            <h2 className="text-2xl font-bold text-white">You are Approved!</h2>
            ...
            <p className="text-sm text-slate-400">{whatsappMessage}</p>
          </div>
        )}
