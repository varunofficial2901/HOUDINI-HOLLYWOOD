...
//                   >
//                     <button
//                       onClick={() => { setIsModalOpen(true); setLoginError(""); }}
//                       className="bg-slate-950 rounded-full px-[1.4rem] py-[0.52rem] flex items-center gap-[0.5rem] font-[700] text-[0.8rem] tracking-[0.06em] text-slate-50 transition-colors duration-250 border-none outline-none group-hover:bg-transparent group-hover:text-white cursor-pointer w-full"
//                       style={{ fontFamily: 'Arial, sans-serif' }}
//                     >
//                       <User className="w-[14px] h-[14px] text-violet-500 group-hover:text-white transition-colors duration-250" />
...
//                 if (el && window.google) {
//                   window.google.accounts.id.initialize({
//                     client_id: "632273202115-8t4nelqmq8f2l08meqm81me0gk7894si.apps.googleusercontent.com",
//                     callback: async (response) => {
//                       try {
//                         const { googleAuthApi } = await import("../api/client");
...
//               {loginError && (
//                 <div className="px-4 py-2.5 rounded-lg bg-red-500/10 border border-red-500/20 text-sm text-red-400 text-center mb-4">
//                   {loginError}
//                 </div>
//               )}
//               <button
//               onClick={handleSignIn}
//               disabled={loginLoading}
//               className="w-full bg-violet-600 hover:bg-violet-500 disabled:opacity-60 text-white font-semibold py-2.5 rounded-lg transition-colors mb-4 flex items-center justify-center gap-2">
//                 {loginLoading ? (
...
//                 {isSignUp ? (
//                   <>Already have an account?{" "}
//                   <button onClick={() => { setIsSignUp(false); setSignUpError(""); }} className="text-violet-400 hover:text-violet-300 transition-colors">Sign In</button>
//                   </>
//                 ) : (
//                 <>Don't have an account?{" "}
//                  <button onClick={() => { setIsSignUp(true); setLoginError(""); }} className="text-violet-400 hover:text-violet-300 transition-colors">Sign Up</button>
//                 </>
//                )}
//               </p>
//               {isSignUp ? (
...
//                     } catch (err) {
//                       const detail = err.response?.data?.detail;
//                       setSignUpError(typeof detail === "string" ? detail : "Sign up failed. Please try again.");
//                     } finally {
//                       setSignUpLoading(false);
//                     }
//                   }}
